...
plugin_name="NotificationSchedulerPlugin"
...
opts.Add(EnumVariable('version', 'Godot version to target', '', ['', '4.1', '4.2', '4.3', '4.4', '4.4.1', '4.5']))
...
if env['version'] == '4.1' or env['version'] == '4.2' or env['version'] == '4.3' or env['version'] == '4.4' or env['version'] == '4.4.1' or env['version'] == '4.5':
